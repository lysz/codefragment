	...
	treeNode.on("click", function(){
		        ...
		        items: [{
		            ...
		            items: [{
		                ...
		                items: [{
		                	...
		                	text: '新增',
		                	handler: function(){
		                		showWindow('新增用户', false, 'user/create');
		                	}
		                }]
		            }]
		        }]
		...
		var grid = Ext.create('Ext.grid.Panel', {
			...
			columns: [
			    ...
			    {header: 'id',        width: 50,   dataIndex: 'userId', sortable: true, hidden: true},
			    ...
			    {header: '备注',      width: 300,   dataIndex: 'description', sortable: false},
                {
	                ...
	                items: [{
	                    ...
	                    handler: function(grid, rowIndex, colIndex) {
	                		...
	                		showWindow('修改用户', true, 'user/create');
	                		
	                		addUserWindow
	                		
	                		addOrModifyUserForm.getForm().load({
		 ...
		 * 新增用户
		 */
		function showWindow(title, isPasswordShow, submitURL){
