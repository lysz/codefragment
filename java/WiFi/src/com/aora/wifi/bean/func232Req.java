...
public class func232Req extends requestBean{
	...
	private String unbind_id=null;
	private String unbind_type=null;
	
	@Override
	public void parse(JSONObject json) {
		if(json!=null && json.size()>0){		
			this.setPara_function("232");
			UID=json.getString("uid");
			this.setPara_uid(UID);
			account=(!json.containsKey("username")?"":json.getString("username"));
			
			unbind_id=(!json.containsKey("unbind_id")?"":json.getString("unbind_id"));
			unbind_type=(!json.containsKey("unbind_type")?"":json.getString("unbind_type"));			
	...
	public void setUnbind_type(String unbind_type) {
		this.unbind_type = unbind_type;
	}
