...
public class ChongZhiAction {
    ...
    public ChongZhiAction() {
        
        this.host = "http://api2.99dou.com:8000/Api/Service";
        this.partner = "10418";
        this.key = "vT5QpWU3Kw7C4Tprh780fLW85ix8fzHVmDj4dLRGh60JdZXhRFgLdWeepujPZC5S";
        this.notify_url = "http://www.wifienjoy.com/WIFI2/coin/callback.do";
        this.notify_url=PropertyInfo.getValue("access.domain", null)+"/WIFI2/coin/callback.do";
    }
    ...
    public int Huafei(String out_trade_id, String account, String account_info,
            ...
            Ref<String> msg, Map<String, String> resultMap) {
        ...
        try {
            ...
            Document doc = db.parse(new ByteArrayInputStream(result.getBytes(CHAR_SET)));
    ...
    public int Direct(String out_trade_id, String product_id, int quantity,
            ...
            int expired_mini, Ref<String> msg, Map<String, String> resultMap) {
        Map<String, String> pars = new HashMap<String, String>();
...
//            Map<String, String> resultMap = new HashMap<String, String>();
    ...
    public int VerifyNotify(
            ...
            Ref<String> out_trade_id, 
            Ref<Integer> success_qty,
            Ref<Integer> fail_qty, Ref<String> msg
            ) {
     ...
     * @return Build_mysign
     */
    private String Build_mysign(Map<String, String> dicArray, String key,
